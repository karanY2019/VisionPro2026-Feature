...
struct ChangeGeneralNameView: View {
    ...
    let errorMsg : String = "Please type in a valid name"
    ...
    var body: some View {
        ...
        VStack(alignment: .center, spacing: 0) {
            ...
            VStack(alignment: .center, spacing: 0) {
                Image("change_general_name_icon")
                    .resizable()
                    .scaledToFit()
                ...
                Text("Type in a new name below to update")
                    .font(.system(size: 15))
            ...
            VStack(alignment: .center, spacing: 0) {
                ...
                TextField("Last Name", text: $lastName)
                    ...
                    .background(
                        Rectangle()
                            ...
                            .overlay(
                                RoundedRectangle(cornerRadius: 3)
                                    .stroke(isLastNameValid ? .white.opacity(0.3) : .red.opacity(0.8), lineWidth: 1)
                            )
                    )
                    .autocapitalization(.none)
                    .disableAutocorrection(true)
                ...
                Button {
                    ...
                    isLastNameValid = UCHelper.validateGeneralName(lastName)
        ...
        .padding(.horizontal, 20)
        .padding(.top, 36)
        .padding(.bottom, (isFirstNameValid && isLastNameValid) ? 36 : 0)
    }
}

#Preview {
    ChangeGeneralNameView(isPresented: Binding.constant(true))
}
